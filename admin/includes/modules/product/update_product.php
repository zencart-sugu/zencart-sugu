 ...
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    ...
    /*
     echo zen_addOnModules_call_function('advanced_stock', 'advanced_stock_set_sendfor_status');
     */
    if (is_object($GLOBALS['advanced_stock']) && $GLOBALS['advanced_stock']) {
      echo $GLOBALS['advanced_stock']->advanced_stock_set_sendfor_status($products_id);
    }
