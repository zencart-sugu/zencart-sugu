...
if (!defined('IS_ADMIN_FLAG')) {
  ...
  class product_notification_with_language {
    var $show_choose_audience, $title, $content, $content_html;

    function product_notification_with_language($title, $content, $content_html, $queryname='') {
...
//--></script>';
    ...
    function confirm() {
      ...
      if (isset($_GET['global']) && ($_GET['global'] == 'true')) {
        if (isset($_GET['languages_id']) && ($_GET['languages_id'] > 0)) $customers_languages_id = (int)$_GET['languages_id'];
        ...
        $chosen = $_POST['chosen'];
        if (isset($_POST['languages_id']) && ($_POST['languages_id'] > 0)) $customers_languages_id = (int)$_POST['languages_id'];
