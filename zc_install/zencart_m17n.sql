...
UPDATE zones_m17n SET zone_name_m17n = 'Ibaragi' WHERE language_id <> 2 AND zone_name_m17n LIKE BINARY '°ñ¾ë¸©';
...
UPDATE zones_m17n SET zone_name_m17n = 'Kanagama' WHERE language_id <> 2 AND zone_name_m17n LIKE BINARY '¿ÀÆàÀî¸©';
...
UPDATE zones_m17n SET zone_name_m17n = 'Aichu' WHERE language_id <> 2 AND zone_name_m17n LIKE BINARY '°¦ÃÎ¸©';
...
UPDATE zones_m17n SET zone_name_m17n = 'Fukushima' WHERE language_id <> 2 AND zone_name_m17n LIKE BINARY 'Ê¡²¬¸©';
