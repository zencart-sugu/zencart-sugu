...
/*		if(substr($line_upper, 0, 12) == 'INSERT INTO '){
		...
		//デモの挿入
		if(substr($line_upper, 0, 12) == 'INSERT INTO '){
			if(preg_match("/(`address_book`)|(`categories`)|(`categories_description`)|(`configuration`)|(`customers`)|(`customers_info`)|(`ezpages`)|(`featured`)|(`group_pricing`)|(`manufacturers`)|(`manufacturers_info`)|(`media_clips`)|(`media_manager`)|(`media_to_products`)|(`meta_tags_categories_description`)|(`meta_tags_products_description`)|(`music_genre`)|(`product_music_extra`)|(`product_types_to_category`)|(`products`)|(`products_attributes`)|(`products_attributes_download`)|(`products_description`)|(`products_discount_quantity`)|(`products_options`)|(`products_options_values`)|(`products_options_values_to_products_options`)|(`products_to_categories`)|(`record_artists`)|(`record_artists_info`)|(`record_company`)|(`record_company_info`)|(`reviews`)|(`reviews_description`)|(`salemaker_sales`)|(`specials`)/", $line)) {
				$demo .= $line."\n";
			}else{
				$def .= $line."\n";
			}
