...
INSERT INTO configuration VALUES (1,'ショップ名','STORE_NAME','すぐでき（る）パック デモショップ','ショップ名を設定します。',1,1,NULL,'2009-11-19 12:39:39',NULL,NULL);
INSERT INTO configuration VALUES (2,'ショップオーナー名','STORE_OWNER','すぐでき（る）パック 開発チーム','ショップオーナー名(または運営管理者名)を設定します。',1,2,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (12,'ショップの住所と電話番号','STORE_NAME_ADDRESS','店舗名:すぐでき（る）パック デモショップ\r\n 住所:東京都中央区銀座\r\n 電話番号:03-XXXX-XXXX','ショップ名、国名、住所、電話番号を設定します。',1,18,'2010-06-18 11:34:11','2009-11-19 12:39:39',NULL,'zen_cfg_textarea(');
...
INSERT INTO configuration VALUES (218,'メールアドレス (ショップに表示する問い合わせ先)','STORE_OWNER_EMAIL_ADDRESS','ohtsuji@ark-web.jp','ショップオーナーのメールアドレスとしてサイト上で表示されるアドレスを設定します。',12,10,NULL,'2009-11-19 12:39:39',NULL,NULL);
INSERT INTO configuration VALUES (219,'メールアドレス (顧客への送信元)','EMAIL_FROM','ohtsuji@ark-web.jp','顧客に送信されるメールのデフォルトの送信元として表示されるアドレスを設定します。<br />\r\n管理画面でメールを作成をする都度、書き換えることもできます。',12,11,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (222,'注文確認メール(コピー)送信先','SEND_EXTRA_ORDER_EMAILS_TO','ohtsuji@ark-web.jp','顧客に送信される注文確認メールのコピーを送付するメールアドレスを設定します。<br />記入例: 名前1 &lt;email@address1&gt;, 名前2 &lt;email@address2&gt;',12,12,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (224,'アカウント作成完了メール(コピー)の送信先','SEND_EXTRA_CREATE_ACCOUNT_EMAILS_TO','ohtsuji@ark-web.jp','アカウント作成完了メールのコピーを送信するメールアドレスを設定します。<br /><br />\r\n記入例： 名前1 &lt;email@address1&gt;, 名前2 &lt;email@address2&gt;',12,14,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (226,'「友達に知らせる」メール(コピー)の送信先','SEND_EXTRA_TELL_A_FRIEND_EMAILS_TO','ohtsuji@ark-web.jp','「友達に知らせる」メールのコピーを送信するメールアドレスを設定します。記入例: 名前1 &lt;email@address1&gt;, 名前2 &lt;email@address2&gt;',12,16,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (228,'ギフト券送付メール(コピー)の送信先','SEND_EXTRA_GV_CUSTOMER_EMAILS_TO','ohtsuji@ark-web.jp','顧客が送付するギフト券送付メールのコピーを送信するメールアドレスを設定します。<br /><br />記入例： 名前1 &lt;email@address1&gt;, 名前2&lt;email@address2&gt;',12,18,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (230,'ショップ運営者からのギフト券送付メール(コピー)の送信先','SEND_EXTRA_GV_ADMIN_EMAILS_TO','ohtsuji@ark-web.jp','ショップ運営者からのギフト券送付メールのコピーを送信するメールアドレスを設定します。<br /><br />\r\n記入例：名前1 &lt;email@address1&gt;, 名前2 &lt;email@address2&gt;',12,20,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (232,'ショップ運営者からのクーポン券送付メール(コピー)の送信先','SEND_EXTRA_DISCOUNT_COUPON_ADMIN_EMAILS_TO','ohtsuji@ark-web.jp','ショップ運営者からのクーポン券送付メールのコピーを送信するメールアドレスを設定します。<br /><br />\r\n記入例： 名前1 &lt;email@address1&gt;, 名前2 &lt;email@address2&gt;',12,22,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (234,'ショップ運営者の注文ステータスメール(コピー)の送信先','SEND_EXTRA_ORDERS_STATUS_ADMIN_EMAILS_TO','ohtsuji@ark-web.jp','ショップ運営者の注文ステータスメールのコピーを送信するメールアドレスを設定します。<br /><br />\r\n記入例： 名前1 &lt;email@address1&gt;, 名前2 &lt;email@address2&gt;',12,24,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (236,'掲載待ちレビューについてのメール送信先','SEND_EXTRA_REVIEW_NOTIFICATION_EMAILS_TO','ohtsuji@ark-web.jp','掲載待ちのレビューについてのメールを送信するアドレスを設定します。<br />フォーマット：Name 1 &lt;email@address1&gt;, Name 2 &lt;email@address2&gt;',12,26,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (241,'在庫わずかになった際のメール送信先','SEND_EXTRA_LOW_STOCK_EMAILS_TO','ohtsuji@ark-web.jp','商品の在庫が水準を下回った際にメールを送信するアドレスを設定します。複数設定することができます。<br />\r\nフォーマット：Name 1 &lt;email@address1&gt;, Name 2 &lt;email@address2&gt;',12,61,NULL,'2009-11-19 12:39:39',NULL,NULL);
...
INSERT INTO configuration VALUES (259,'セッション情報保存ディレクトリ','SESSION_WRITE_DIRECTORY','/var/www/projects/z/zen-cart/htdocs/ohtsuji/zencart-sugu/cache','セッション管理がファイルベースの場合に保存するディレクトリを設定します。',15,1,NULL,'2009-11-19 12:39:39',NULL,NULL);
