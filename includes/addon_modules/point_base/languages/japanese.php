...
define('SUCCESS_ADDPOINT_DEPOSIT', '購入ポイントが使用可能になりました。');
define('SUCCESS_ADDPOINT_CANCEL', '購入ポイントが取り消されました。');
define('SUCCESS_ADDPOINT_DELETE', '購入ポイントが削除されました。');
define('SUCCESS_SUBPOINT_CANCEL', '使用ポイントが取り消されました。');
define('SUCCESS_SUBPOINT_DELETE', '使用ポイントが削除されました。');

define('SUCCESS_CUSTOMERS_POINTS_DELETE', '会員のポイントが削除されました。');

define('MODULE_POINT_BASE_BLOCK_TITLE', '現在のポイント残額');
define('TEXT_CUSTOMERS_POINT_DEPOSIT', 'ご利用可能ポイント残額');
define('TEXT_CUSTOMERS_POINT_PENDING', '保留中のポイント額');
define('TEXT_CUSTOMERS_POINT_UPDATED', '最終更新日時');
