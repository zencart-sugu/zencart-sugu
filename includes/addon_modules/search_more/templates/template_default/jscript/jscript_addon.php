...
?>
<script language="javascript" src="<?php echo $prefix_image_host  ?>includes/general.js" type="text/javascript"></script>
...
function check_search_more_form() {
  ...
  if ((dfrom.length > 0) && (dfrom != '<?php echo DOB_FORMAT_STRING; ?>')) {
    if (!IsValidDate(dfrom, '<?php echo DOB_FORMAT_STRING; ?>')) {
      error_message = error_message + "* <?php echo MODULE_SEARCH_MORE_ERROR_INVALID_FROM_DATE; ?>\n";
  ...
  if ((dto.length > 0) && (dto != '<?php echo DOB_FORMAT_STRING; ?>')) {
    if (!IsValidDate(dto, '<?php echo DOB_FORMAT_STRING; ?>')) {
      error_message = error_message + "* <?php echo MODULE_SEARCH_MORE_ERROR_INVALID_TO_DATE; ?>\n";
  ...
  if ((dfrom.length > 0) && (dfrom != '<?php echo DOB_FORMAT_STRING; ?>') && (IsValidDate(dfrom, '<?php echo DOB_FORMAT_STRING; ?>')) && (dto.length > 0) && (dto != '<?php echo DOB_FORMAT_STRING; ?>') && (IsValidDate(dto, '<?php echo DOB_FORMAT_STRING; ?>'))) {
    if (!CheckDateRange(document.search_more_form.dfrom, document.search_more_form.dto)) {
      error_message = error_message + "* <?php echo MODULE_SEARCH_MORE_ERROR_TO_DATE_LESS_THAN_FROM_DATE; ?>\n";
      error_field = document.search_more_form.dto;
      error_found = true;
    }
  }
  ...
  if (pfrom.length > 0) {
    ...
    if (isNaN(pfrom_float)) {
      error_message = error_message + "* <?php echo MODULE_SEARCH_MORE_ERROR_PRICE_FROM_MUST_BE_NUM; ?>\n";
  ...
  if (pto.length > 0) {
    ...
    if (isNaN(pto_float)) {
      error_message = error_message + "* <?php echo MODULE_SEARCH_MORE_ERROR_PRICE_TO_MUST_BE_NUM; ?>\n";
  ...
  if ( (pfrom.length > 0) && (pto.length > 0) ) {
    if ( (!isNaN(pfrom_float)) && (!isNaN(pto_float)) && (pto_float < pfrom_float) ) {
      error_message = error_message + "* <?php echo MODULE_SEARCH_MORE_ERROR_PRICE_TO_LESS_THAN_PRICE_FROM; ?>\n";
      error_field = document.search_more_form.pto;
      error_found = true;
    }
  }
  ...
  if (error_found == true) {
    ...
    RemoveFormatString(document.search_more_form.keyword, "<?php echo MODULE_SEARCH_MORE_KEYWORD_FORMAT_STRING; ?>");
    RemoveFormatString(document.search_more_form.dfrom, "<?php echo DOB_FORMAT_STRING; ?>");
    RemoveFormatString(document.search_more_form.dto, "<?php echo DOB_FORMAT_STRING; ?>");
    return true;
  }
}
