...
define('MODULE_SUPER_PRODUCTS_LIST_STATUS_TITLE', 'Eenable スーパー商品一覧');
define('MODULE_SUPER_PRODUCTS_LIST_STATUS_DESCRIPTION', 'Enable スーパー商品一覧 ? <br />true: enable<br />false: disable');
define('MODULE_SUPER_PRODUCTS_LIST_SORT_ORDER_TITLE', 'sort_order');
define('MODULE_SUPER_PRODUCTS_LIST_SORT_ORDER_DESCRIPTION', 'sort order');
...
define('MODULE_SUPER_PRODUCTS_LIST_TEXT_TOP_CATEGORIES', 'ホーム');
define('MODULE_SUPER_PRODUCTS_LIST_NOSCRIPT_WARNING',  'JavaScriptをオンにしてください');
define('MODULE_SUPER_PRODUCTS_LIST_CATEGORIES_SEPARATE', '&nbsp;&gt;&nbsp;');

define('MODULE_SUPER_PRODUCTS_LIST_ERROR_INVALID_CATEGORIES_ID', '不正なカテゴリIDです');
define('MODULE_SUPER_PRODUCTS_LIST_ERROR_INVALID_MANUFACTURERS_ID', '不正なメーカーIDです');

define('MODULE_SUPER_PRODUCTS_LIST_TEXT_FEATURED', 'おすすめ商品');
define('MODULE_SUPER_PRODUCTS_LIST_TEXT_SPECIALS', 'セール商品');
?>
