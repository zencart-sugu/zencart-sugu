...
define('MODULE_SUPER_PRODUCTS_LIST_SENNA_STATUS_DESCRIPTION', '別途sennaのインストールを行う必要があります <br />true: 有効<br />false: 無効');
...
define('MODULE_SUPER_PRODUCTS_LIST_FROM_TO',         '<strong>%d</strong>から<strong>%d</strong> を表示中 (商品の数: <strong>%d</strong>)');
