...
define('MODULE_EASY_ADMIN_PRODUCTS_COPY_NEW_PRODUCTS_MODEL',      '<strong>新商品の型番</strong>　<font color="red">必須</font>');
define('MODULE_EASY_ADMIN_PRODUCTS_COPY_NEW_PRODUCTS_MODEL_REMARK', '※新商品は元の商品とは別商品という扱いでコピーされます。<br />型番は他の商品と同じものは利用できません。新商品の型番を指定してください。');
