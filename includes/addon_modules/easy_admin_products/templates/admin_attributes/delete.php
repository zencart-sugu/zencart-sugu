...
<?php echo $html->form('delete', 'attributes'); ?>
  ...
  <input type="hidden" name="options_name"   value="<?php echo htmlspecialchars($attribute["options_name"]); ?>">
  <input type="hidden" name="options_values_name"   value="<?php echo htmlspecialchars($attribute["options_value_name"]); ?>">

<h3><?php echo MODULE_EASY_ADMIN_PRODUCTS_ATTRIBUTES_DELETE_TITLE; ?></h3>
<div>
