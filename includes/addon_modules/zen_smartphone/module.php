...
/*
        $db->Execute("delete from " . TABLE_TAX_CLASS_M17N .                  " where language_id="  . (int)$languages_id);
        $db->Execute("delete from " . TABLE_TAX_RATES_M17N .                  " where language_id="  . (int)$languages_id);
        $db->Execute("delete from " . TABLE_CURRENCIES_M17N .                 " where language_id="  . (int)$languages_id);
        $db->Execute("delete from " . TABLE_GROUP_PRICING_M17N .              " where language_id="  . (int)$languages_id);
        $db->Execute("delete from " . TABLE_ZONES_M17N .                      " where language_id="  . (int)$languages_id);
*/
