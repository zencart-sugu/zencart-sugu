...
<?php
 ...
 echo '<div class="buttonRow forward"><a href="' . zen_href_link(FILENAME_ADDON,'module=easy_reviews/product_reviews_write&products_id='.$_GET['products_id']) . '">' . zen_image_button(BUTTON_IMAGE_WRITE_REVIEW, BUTTON_WRITE_REVIEW_ALT) . '</a></div><br class="clearBoth">';
 }
?>
</div>
<?php
