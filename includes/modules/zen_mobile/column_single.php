...
$column_single_display= $db->Execute("select layout_box_name from " . TABLE_LAYOUT_BOXES . " where (layout_box_location=0 or layout_box_location=1) and layout_box_status_single=1 and layout_template ='" . $template_dir . "' and layout_page = '" . zen_db_prepare_input($layout_page) . "'" . ' order by LPAD(layout_box_sort_order_single,11,"0")');
// safety row stop
$box_cnt=0;
