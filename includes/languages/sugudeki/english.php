...
define('HEADER_SKIP_MAIN', 'Go to main content');
define('HEADER_SKIP_MENU', 'Go to menu');

//define('GLOBAL_HEADER_LOGO', '<p class="logo"><img src="'.$images.'global-header_logo.gif" alt="reliable consumer" width="145" height="22" /></p>');
...
if (STORE_STATUS == '0') {
  ...
  define('TEXT_GREETING_GUEST', 'Hello <span>%s</span>!');
}
define('TEXT_GREETING_PERSONAL', '%s');
/*
define('HEADER_TEXT_FOR_VISITOR', '
<p id="greeting">Hello <span>'.zen_customer_greeting().'</span>!</p>
');
*/
define('HEADER_TEXT_FOR_VISITOR', '<p id="greeting">hello. <a href="'.zen_href_link(FILENAME_ADDON, '&module=visitors/visitor_to_account', 'SSL').'">The account can register by take over input information. </a></p>');

define('HEADER_TEXT_FOR_ACCOUNT', '
<p id="greeting"><strong>Hello.&nbsp;<a href="'.zen_href_link(FILENAME_ACCOUNT, '', 'SSL').'" title="'.zen_customer_greeting().'\'s page">'.zen_customer_greeting().'\'s page</a>¤Ø</strong> | <a href="'. zen_href_link(FILENAME_LOGOFF, '', 'NONSSL').'" title="Logout">Logout</a></p>
');

define('HEADER_TEXT_FOR_NOACCOUNT', '
<p id="greeting">'.zen_customer_greeting().'&nbsp;Do you want to <a href="'.zen_href_link(FILENAME_LOGIN, '', 'SSL').'" title="Login">login</a>?&nbsp;First Visit You can <a href="'.zen_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL').'" title="Free sign-in">sign-in</a> free.</p>
');

/*
define('GLOBAL_HEADER_NAV', '
<ul class="nav">
<li><a href="#" title="Member Services">Member Services</a></li>
<li><a href="#" title="All carts">All Carts</a></li>
<li><a href="#" title="About Mall">About Mall</a></li>
</ul>
');
*/
define('GLOBAL_HEADER_NAV', '');
...
<dd>
<ul>
<li class="font-small"><a href="javascript:void(0)" rel="styles3" class="styleswitch" id="id-font-small">Smaller font size</a></li>
<li class="font-nomal"><a href="javascript:void(0)" rel="styles1" class="styleswitch" id="id-font-normal">Undo font size</a></li>
<li class="font-large"><a href="javascript:void(0)" rel="styles2" class="styleswitch" id="id-font-large">Larger font size</a></li>
</ul>
</dd>
</dl>
<!-- /font-size -->
...
define('HEADLINE_INFORMATION', '<h2>Information</h2>');
define('TEXT_PRICE_KN', 'Price¡§');
define('TEXT_PRICE_TAX', '<span class="tax">(gross)</span>');

define('PAGETOP', 'Back to Top');

//Product List
define('TEXT_PRICE_EN', 'Yen');
define('DOB_FORMAT_STRING_SAMPLE', '<span>Eg¡§2009/01/01¡¡¡Á¡¡2009/06/30</span>');
define('KEYWORD_FORMAT_STRING', 'Please input a keyword');

//Product Detail
define('TEXT_PRODUCT_PRICE', 'Price');
define('TEXT_PRODUCT_SECURITY', 'Extension security');
define('PRODUCTS_ORDER_QTY', 'Quantity');
define('HEADELINE_PRODUCT_DESCRIPTION', '<h2>Product Description</h2>');


//Register
define('TABLE_HEADING_NAME', 'Name');
define('ENTRY_NAME', 'Full name¡ÊKanji¡Ë');
define('ENTRY_KANA', 'Full name¡ÊHiragana¡Ë');

define('ENTRY_SAMPLE_01', 'Alphanumeric Eq: example@sample.co.jp');
define('ENTRY_SAMPLE_02', 'Alphanumeric Five characters or more');
define('ENTRY_SAMPLE_03', 'Please enter your password again to confirm.');
define('ENTRY_SAMPLE_04', ''); // Eq¡§Japan');
define('ENTRY_SAMPLE_05', ''); // Eq¡§');
define('ENTRY_SAMPLE_06', ''); // Eq¡§');
define('ENTRY_SAMPLE_07', ''); // Eq¡§');
define('ENTRY_SAMPLE_08', 'Numbers and Hyphen(-) Eq. 123-4567');
define('ENTRY_SAMPLE_09', 'Eq. New York');
define('ENTRY_SAMPLE_10', 'Eq. 253 West 42nd St.,');
define('ENTRY_SAMPLE_11', 'Eq. Topanga Bld.,');
define('ENTRY_SAMPLE_12', 'Numbers and Hyphen(-) Eq. 03-1234-5678');
define('ENTRY_SAMPLE_13', 'Eq. 1970/05/21');
define('ENTRY_SAMPLE_00', '<a href="http://www.post.japanpost.jp/zipcode/" target="_blank">Find a zip code</a>');


//Order
define('HEADING_COMMENTS', 'Remarks');
define('TABLE_HEADING_PRICE','Price');
define('ORDERTOTALS_SHIPPUING','Shipping charges');
...
// javascript messages
  ...
  // ->furikana
  define('ENTRY_FIRST_NAME_KANA', 'First Name(Hiragana)');
  define('ENTRY_FIRST_NAME_KANA_ERROR', 'Is your first name correct? Our system requires a minimum of ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' characters. Please try again.');
  define('ENTRY_FIRST_NAME_KANA_TEXT', '*');
  define('ENTRY_LAST_NAME_KANA', 'Last Name(Hiragana)');
  define('ENTRY_LAST_NAME_KANA_ERROR', 'Is your last name correct? Our system requires a minimum of ' . ENTRY_LAST_NAME_MIN_LENGTH . ' characters. Please try again.');
  define('ENTRY_LAST_NAME_KANA_TEXT', '*');
  // <-furikana
  define('ENTRY_DATE_OF_BIRTH', 'Date of Birth:');
  define('ENTRY_DATE_OF_BIRTH_ERROR', 'Is your birth date correct? Our system requires the date in this format: MM/DD/YYYY (eg. 1970/05/21)');
  define('ENTRY_DATE_OF_BIRTH_TEXT', '* (eg. 1970/05/21)');
  ...
  // ->
  define('ENTRY_TELEPHONE_NOMATCH', 'Telephone number can input only numbers or hyphens');
  // <-
  ...
  // ->
  define('ENTRY_FAX_NOMATCH', 'Fax number can input only numbers or hyphens');
  // <-
  ...
  define('ENTRY_HIRAKANA_NOMATCH',   ' can be entered only hiragana');
  // <-
  ...
  define('TEXT_REQUIRED', '<img src="'.$template->get_template_dir('icon_required2.gif',DIR_WS_TEMPLATE, $current_page_base,'images/').'/icon_required.gif" alt="Required" />');
  define('TEXT_REQUIRED2', '<img src="'.$template->get_template_dir('icon_required2.gif',DIR_WS_TEMPLATE, $current_page_base,'images/').'/icon_required2.gif" alt="Required" />');

  define('TEXT_TIME_SPECIFY','specify of delivery time zone&nbsp;');
  // <-
...
// Shipping Estimator
  ...
  // ->
  define('CART_SHIPPING_METHOD_RECALCULATE_TXT','Please push "Recalculation" button when you change the amount. ');
  // <-
...
// sort order titles for dropdowns
  ...
  // ->
  define('TEXT_INFO_SORT_BY_PRODUCTS_MANUFACTURER', 'Manufacturer');
  define('TEXT_INFO_SORT_BY_PRODUCTS_MANUFACTURER_DESC', 'Manufacturer - desc');
  // <-
...
// create account - login shared
  ...
  // ->
  define('LOGIN_DETAILS_TEXT', 'Please input your email address and password to use when you login.');
  // <-
