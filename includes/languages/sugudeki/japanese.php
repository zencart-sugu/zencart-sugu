...
define('ENTRY_SAMPLE_04', '例：安心');
define('ENTRY_SAMPLE_05', '例：太郎');
define('ENTRY_SAMPLE_06', '例：あんしん');
...
// javascript messages
  ...
  // ->furikana
  define('ENTRY_FIRST_NAME_KANA', '姓(かな)');
  define('ENTRY_FIRST_NAME_KANA_ERROR', '姓かなは最低' . ENTRY_FIRST_NAME_MIN_LENGTH . '文字以上入力してください');
  define('ENTRY_FIRST_NAME_KANA_TEXT', '必須');
  define('ENTRY_LAST_NAME_KANA', '名(かな)');
  define('ENTRY_LAST_NAME_KANA_ERROR', '名かなは最低' . ENTRY_LAST_NAME_MIN_LENGTH . '文字以上入力してください');
