...
//携帯用
  define('MOBILE_BODY_PROPERTY', '');

//BODYのプロパティ
  define('MOBILE_BODY_PROPERTY', 'bgcolor="#FFFFFF" text="#000000" link="#0000FF" vlink="#990099" alink="#FFFFFF"');

//第２階層以降のサイトタイトル	
  define('MOBILE_TITLE', '<div align="center">Zen Cart ﾓﾊﾞｲﾙ[日本語版]</div>');
	
//タイトル装飾
  define('MOBILE_TITLE_START', '<font color="' . MOBILE_THEME_COLOR . '" size="+1">■');
  define('MOBILE_TITLE_FINISH', '</font>');
//リスト
  define('MOBILE_LIST', '<font color="' . MOBILE_THEME_COLOR . '">□</font>');
  define('BOX_HEADING_CATEGORIES_LIST', '□');
  define('TEXT_SQUARE','■'); 

//前のページに戻る
  define('MOBILE_HISTORY_BACK', '<<戻る');
	
  define('MOBILE_UNSUBSCRIBE', '【購読を停止する】');	
	
  define('MOBILE_CONTINUE_SHOPPING', '【買い物を続ける】');	

  define('FOOTER_TEXT_BODY', '<div align="center"><font size="1">Copyright &copy; <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a><br> Powered by <a href="http://www.zen-cart.com" target="_blank">zen-cart.com</a> / <a href="http://www.zen-cart.jp" target="_blank">zen-cart.jp</a></font></div>');
...
// whats_new box text in sideboxes/whats_new.php
  ...
  define('CATEGORIES_BOX_HEADING_WHATS_NEW', '<font color="' . MOBILE_THEME_COLOR . '">&#xE6DD;</font>新着商品...');

  define('BOX_HEADING_FEATURED_PRODUCTS', 'おすすめ');
  define('CATEGORIES_BOX_HEADING_FEATURED_PRODUCTS', '<font color="' . MOBILE_THEME_COLOR . '">&#xE729;</font>おすすめ商品...');
  define('TEXT_NO_FEATURED_PRODUCTS', 'おすすめ商品はまもなく登録されますので、また後ほどご覧ください。');

  define('TEXT_NO_ALL_PRODUCTS', '商品はまもなく登録されますので、また後ほどご覧ください。');
  define('CATEGORIES_BOX_HEADING_PRODUCTS_ALL', '<font color="' . MOBILE_THEME_COLOR . '">□</font>全商品...');

// quick_find box text in sideboxes/quick_find.php
  define('BOX_HEADING_SEARCH', 'キーワードで探す');
  define('BOX_SEARCH_ADVANCED_SEARCH', '詳細検索');

// specials box text in sideboxes/specials.php
  define('BOX_HEADING_SPECIALS', '特価商品');
  define('CATEGORIES_BOX_HEADING_SPECIALS','<font color="' . MOBILE_THEME_COLOR . '">□</font>特価商品 ...');
...
// reviews box text in sideboxes/reviews.php
  ...
  define('BOX_REVIEWS_RANK', '評価:');
  define('BOX_REVIEWS_COMMENT', 'コメント:');
...
// information box text in sideboxes/information.php
  define('BOX_HEADING_INFORMATION', '<font color="' . MOBILE_THEME_COLOR . '">■</font>インフォメーション');
...
// javascript messages
  ...
  define('ENTRY_GENDER_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_FIRST_NAME', '姓:');
  define('ENTRY_FIRST_NAME_ERROR', '姓は最低' . ENTRY_FIRST_NAME_MIN_LENGTH . '文字以上入力してください');
  define('ENTRY_FIRST_NAME_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_LAST_NAME', '名:');
  define('ENTRY_LAST_NAME_ERROR', '名は最低' . ENTRY_LAST_NAME_MIN_LENGTH . '文字以上入力してください');
  define('ENTRY_LAST_NAME_TEXT', '<font color="#FF0000">*</font>');
  // ->furikana
  define('ENTRY_FIRST_NAME_KANA', '姓フリガナ:');
  define('ENTRY_FIRST_NAME_KANA_ERROR', '姓フリガナは最低' . ENTRY_FIRST_NAME_MIN_LENGTH . '文字以上入力してください');
  define('ENTRY_FIRST_NAME_KANA_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_LAST_NAME_KANA', '名フリガナ:');
  define('ENTRY_LAST_NAME_KANA_ERROR', '名フリガナは最低' . ENTRY_LAST_NAME_MIN_LENGTH . '文字以上入力してください');
  ...
  define('ENTRY_STREET_ADDRESS_TEXT', '<font color="#FF0000">*</font>');
  ...
  define('ENTRY_POST_CODE_TEXT', '<font color="#FF0000">*</font>');
  ...
  define('ENTRY_CITY_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_STATE', '都道府県:');
  define('ENTRY_STATE_ERROR', '都道府県名は最低' . ENTRY_STATE_MIN_LENGTH . '文字以上入力してください');
  define('ENTRY_STATE_ERROR_SELECT', '都道府県が正しくありません。「都」「道」「府」「県」などを含め入力してください (例: 東京都)');
  define('ENTRY_STATE_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_COUNTRY', '国名:');
  define('ENTRY_COUNTRY_ERROR', '国名を正しく入力して下さい(例：Japan');
  define('ENTRY_COUNTRY_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_TELEPHONE_NUMBER', '電話番号:');
  define('ENTRY_TELEPHONE_NUMBER_ERROR', '電話番号は最低' . ENTRY_TELEPHONE_MIN_LENGTH . '文字以上入力してください');
  define('ENTRY_TELEPHONE_NUMBER_TEXT', '<font color="#FF0000">*</font>');
  ...
  define('ENTRY_PASSWORD_TEXT', '<font color="#FF0000">*</font><br>半角英数字で最低' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上)');
  define('ENTRY_PASSWORD_CONFIRMATION', 'パスワードの確認:');
  define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '<font color="#FF0000">*</font>');
  define('ENTRY_PASSWORD_CURRENT', '現在のパスワード:');
  define('ENTRY_PASSWORD_CURRENT_TEXT', '<font color="#FF0000">*</font>');
  ...
  define('ENTRY_PASSWORD_NEW_TEXT', '<font color="#FF0000">*</font>');
  ...
  define('FORM_REQUIRED_INFORMATION', '<font color="#FF0000">*必須項目</font>');
  define('ENTRY_REQUIRED_SYMBOL', '<font color="#FF0000">*</font>');

  // constants for use in zen_prev_next_display function
  define('TEXT_RESULT_PAGE', '');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS','%dから%dを表示中(商品の数:%d)');
define('TEXT_DISPLAY_NUMBER_OF_ORDERS','%dから%dを表示中(ご注文数:%d)');
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS','%dから%dを表示中(レビュー数:%d)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW','%dから%dを表示中(新着商品の数:%d)');
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS','%dから%dを表示中(特価商品の数:%d)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_FEATURED_PRODUCTS','%dから%dを表示中(おすすめ商品の数:%d)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_ALL','%dから%dを表示中(全商品の数:%d)');
...
// IP Address
  define('TEXT_YOUR_IP_ADDRESS','<hr size="1" width="95%" align="center" color="<?php echo MOBILE_THEME_COLOR?>">IPアドレス: ');
...
//
  define('PRODUCT_PRICE_DISCOUNT_ARROW_FOR_MOBILE', ' → ');
...
// create account - login shared
  ...
  define('TEXT_PRIVACY_CONDITIONS_DESCRIPTION', '弊社の個人情報保護方針に同意される場合はチェックボックスをクリックしてください。個人情報保護方針は');
  define('TEXT_PRIVACY_CONDITIONS_CONFIRM', '個人情報保護方針に同意します');
  define('TABLE_HEADING_ADDRESS_DETAILS', '□基本情報');
...
// EZ-PAGES Alerts
  ...
  //logout_confirm
  define('TEXT_LOGOUT_CONFIRM_YES','ログアウトして指定のページに進む');
  define('TEXT_LOGOUT_CONFIRM_NO','戻る');
  define('TEXT_LOGOUT_CONFIRM_DESCRIPTION','セキュリティ確保のためご指定のページにすすむと自動的にログアウトされます。<br>このため再度レジやマイページに進む時はもう一度ログインをしなければなりません。<BR>(ログアウトをするとカートの中身は一旦削除されますが、再度ログインするとカート内容が復元されます。)<br><br>ログアウトしてもよろしいですか?');

  define('TEXT_SECURE_PAGE_NOTICE','注意!!&nbsp;このページでは「戻る」や「リロード」をすると自動でログアウトしてしまうのでご注意ください<br><br>');

  
  
  define('BOX_HEADING_ACCOUNT_MENU', '<font color="' . MOBILE_THEME_COLOR . '">■</font>メニュー');
  define('BOX_HEADING_COLORBOX', '<font color="' . MOBILE_THEME_COLOR . '">■</font>');
  define('TEXT_TRASH_BOX','カートから削除');
  define('TEXT_BACK','元のページに戻る');
  define('TEXT_EMAIL_SUCCESSFUL_SENT_MOBILE', 'おすすめメールを送信しました。');
  define('TEXT_HERE','こちら');
  define('TEXT_MAKER_DIST','メーカーで分類');
  define('TEXT_EASY_LOGIN_ERROR','エラー:簡単ログインをご利用頂くには予め設定が必要です<br>通常ログイン後マイページから簡単ログインの設定をして下さい');
  define('TEXT_EASY_LOGIN_CONFIG','簡単ﾛｸﾞｲﾝ設定');
  define('MOBILE_SERIAL_DUPLICATION_ERROR','お使いの端末は既に登録されていますのでログインして下さい。');
  define('TEXT_ETC_PRODUCT_IMAGE','その他の商品画像<br />');
  define('TEXT_SEARCH_MAKER','メーカーで探す');
  ///////////////////////////////////////////////////////////
