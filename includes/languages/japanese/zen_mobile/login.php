...
define('HEADING_EASY_LOGIN', '【簡単ログイン】<br>簡単ログインを設定済みの方は以下のボタンをクリックするだけでログイン出来ます');
...
define('MOBILE_NEW_ACCOUNT', '【アカウントをお持ちで無い方は】<br>');

define('MOBILE_NEW_ACCOUNT_ENTRY', '→アカウント新規登録フォームへ');
?>
