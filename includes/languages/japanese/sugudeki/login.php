...
define('HEADING_TITLE', 'ログイン');

define('HEADING_NEW_CUSTOMER', 'はじめての方・会員登録されていない方');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', '<p class="attention">この機会に是非ご登録ください!</p>
<p>' . STORE_NAME . 'では、一度アカウントを作成していただきますと以降のご利用ではお客様情報などの入力を省くことができ、快適にショッピングを楽しんでいただけます。</p>
<p><strong>会員登録なしでもご購入いただけます。</strong></p>
');

define('HEADING_RETURNING_CUSTOMER', '会員登録済みの方');

define('TEXT_RETURNING_CUSTOMER', 'ログインIDとパスワードをご入力のうえ、<strong>「ログインする」</strong>ボタンをクリックしてください。 ');
