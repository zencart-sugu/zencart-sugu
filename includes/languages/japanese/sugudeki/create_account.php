...
//define('FLOW', '<img src="'.$images.'flow_create_account.gif" alt="お客様情報の入力" width="688" height="34" />');
define('FLOW', '');

define('NAVBAR_TITLE', '新規会員登録');

define('HEADING_TITLE', '新規会員登録');

define('TEXT_ORIGIN_LOGIN', '下記の項目をご入力ください。入力が終わりましたら、ページ下の<strong>「入力内容の確認」</strong>ボタンを押してください。');
