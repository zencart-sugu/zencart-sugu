...
define('NAVBAR_TITLE_2', 'ご請求先住所の変更');

define('HEADING_TITLE', 'ご請求先住所の変更');

define('TABLE_HEADING_PAYMENT_ADDRESS', 'ご請求先住所');
define('TEXT_SELECTED_PAYMENT_DESTINATION', '下記のフォームで新しいご請求先住所を設定してください。');
define('TITLE_PAYMENT_ADDRESS', '現在のご請求先');
