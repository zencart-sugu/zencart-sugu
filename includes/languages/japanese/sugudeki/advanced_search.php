...
#検索条件フォームで使用する文言
define('MODULE_SEARCH_MORE_ENTRY_KEYWORD', 'キーワードで絞り込む');
define('MODULE_SEARCH_MORE_TEXT_SEARCH_IN_DESCRIPTION', '商品説明文も検索対象にする');
define('MODULE_SEARCH_MORE_ENTRY_CATEGORIES', 'カテゴリーで絞り込む');
define('MODULE_SEARCH_MORE_ENTRY_INCLUDE_SUBCATEGORIES', 'サブカテゴリーを含む');
define('MODULE_SEARCH_MORE_ENTRY_MANUFACTURERS', 'メーカーで絞り込む');
define('MODULE_SEARCH_MORE_ENTRY_PRICE_RANGE', '価格帯で絞り込む');
define('MODULE_SEARCH_MORE_ENTRY_DATE_RANGE', '登録日で絞り込む');
