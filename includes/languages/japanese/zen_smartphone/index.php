...
*/
// 新しくdefineしたのは includes/languages/zen_smartphone/japanese.php に記述した (下記はダミー)
//define('TEXT_GREETING_FOR_SMARTPHONE_GUEST', '');
//define('TEXT_GREETING_FOR_SMARTPHONE_PERSONAL', '');
// <- zen_smartphone: Greeting部分は新しくdefineした方を使う
