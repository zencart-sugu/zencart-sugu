...
<h2 class="headline"><?php echo BOX_INFORMATION_HEADING; ?></h2>
...
<div class="submit"><?php echo zen_back_link() . zen_image_button(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT,'class="imgover"') . '</a>'; ?></div>
</div></div>
