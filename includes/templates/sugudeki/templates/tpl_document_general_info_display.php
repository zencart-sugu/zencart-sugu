...
?>
    <p id="productInfoLink" class="docGeneral centeredContent"><?php echo sprintf(TEXT_MORE_INFORMATION, zen_href_link(FILENAME_REDIRECT, 'action=url&goto=' . urlencode(ereg('^http:\/\/', $products_url) ? substr($products_url,7) : $products_url ), 'NONSSL', true, false)); ?></p>
<?php
