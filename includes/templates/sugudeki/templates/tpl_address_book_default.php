...
<h2 class="headline"><?php echo PRIMARY_ADDRESS_TITLE; ?></h2>
<address><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['customer_default_address_id'], true, ' ', '<br />'); ?></address>
<p class="instructions"><?php echo PRIMARY_ADDRESS_DESCRIPTION; ?></p>


<h2 class="headline"><?php echo ADDRESS_BOOK_TITLE; ?></h2>
...
?>
<h3 class="headline"><?php echo zen_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?><?php if ($addresses['address_book_id'] == $_SESSION['customer_default_address_id']) echo '&nbsp;' . PRIMARY_ADDRESS ; ?></h3>
