...
?>
<div class="back">
<div id="reviewsInfoDefaultProductImage" class="centeredContent back"><?php
...
<h3 class="rating"><?php echo zen_image(DIR_WS_TEMPLATE_IMAGES . 'stars_' . $review_info->fields['reviews_rating'] . '.gif', sprintf(TEXT_OF_5_STARS, $review_info->fields['reviews_rating'])); ?></h3>
