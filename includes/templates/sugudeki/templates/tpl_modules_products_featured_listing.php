...
?>
          <tr>
		  	<td colspan="3"  valign="top" class="main" align="center">
			<div class="productDetailsWrap">
            <div class="productDetails" style="widht:<?php echo IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH + 10; ?>px; margin-left:<?php echo IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH + 10; ?>px; _margin-left:<?php echo IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH / 2 + 10; ?>px; ">
              <?php
			...
			<div class="productImg" style="width:<?php echo IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH + 10; ?>px; margin-left:-100%;">
              <?php
