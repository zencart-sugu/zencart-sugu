...
<h1 id="productListHeading"><?php echo BOX_HEADING_COLORBOX. $breadcrumb->last(); ?></h1>
...
<?php
  ...
  echo zen_draw_pull_down_menu('filter_id', $options, (isset($_GET['filter_id']) ? $_GET['filter_id'] : ''), '');
  
  echo '<br><input type="submit" value='.TEXT_MAKER_DIST.'>';
