...
?>
<div class="floatingBox important forward">
<font size=2>
<?php echo TEXT_SELECTED_BILLING_DESTINATION; ?></div>
</font><br>

<h2 id="checkoutPaymentHeadingAddress"><?php echo BOX_HEADING_COLORBOX.TITLE_BILLING_ADDRESS; ?></h2>
...
<legend id="checkoutPaymentHeadingTotal"><?php echo BOX_HEADING_COLORBOX.TEXT_YOUR_TOTAL; ?><br></legend>
<?php
...
?>
    <br>
<fieldset>
<legend><?php echo BOX_HEADING_COLORBOX.$selection[$i]['module']; ?></legend>
...
<br>
<br>
<?php echo BOX_HEADING_COLORBOX.TABLE_HEADING_PAYMENT_METHOD; ?>
...
<br>
<div class="buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_CONTINUE_CHECKOUT, TEXT_CONTINUE_CHECKOUT_PROCEDURE, 'onclick="submitFunction('.zen_user_has_gv_account($_SESSION['customer_id']).','.$order->info['total'].')"'); ?></div>
