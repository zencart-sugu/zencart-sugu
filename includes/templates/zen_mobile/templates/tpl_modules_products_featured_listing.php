...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
          <tr>
            <td colspan="3"><hr size="1" width="95%" align="center" color="<?php echo MOBILE_THEME_COLOR?>"></td>
          </tr>
<?php
  ...
  if ($featured_products_split->number_of_rows > 0) {
    ...
    while (!$featured_products->EOF) {
      ...
      if (PRODUCT_FEATURED_LIST_NAME != '0') {
        $display_products_name = $access_key.' href="' . zen_href_link(zen_get_info_page($featured_products->fields['products_id']), 'products_id=' . $featured_products->fields['products_id']) . '"><strong>' . $featured_products->fields['products_name'] . '</strong></a>' . str_repeat('<br clear="all" />', substr(PRODUCT_FEATURED_LIST_NAME, 3, 1));
      } else {
