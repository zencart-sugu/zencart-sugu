...
<div id="reviewsInfoDefaultProductPageLink" class="buttonRow">
<?php echo '<a href="' . zen_href_link(zen_get_info_page($_GET['products_id']), zen_get_all_get_params(array('reviews_id'))) . '">' . BUTTON_GOTO_PROD_DETAILS_ALT . '</a>'; ?></div>

<div id="reviewsInfoDefaultReviewsListingLink" class="buttonRow">
<?php echo ($reviews_counter > 1 ? '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params(array('reviews_id'))) . '">' . BUTTON_MORE_REVIEWS_ALT . '</a>' : ''); ?></div>

<div class="buttonRow">
<?php echo '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, zen_get_all_get_params(array('reviews_id'))) . '">' . BUTTON_WRITE_REVIEW_ALT . '</a>'; ?></div>
</div>
...
echo zen_break_string(nl2br(zen_output_string_protected(stripslashes($review_info->fields['reviews_text']))), 60, ''); ?>
</div>
