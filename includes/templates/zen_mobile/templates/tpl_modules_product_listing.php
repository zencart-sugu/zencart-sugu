 ...
 */
 ...
 if ($error_categories == false) {
   require($template->get_template_dir('/tpl_modules_listing_display_order2.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_listing_display_order2.php');
 }
