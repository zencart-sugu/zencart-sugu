...
<label class="inputLabel" for="contactname"><?php echo ENTRY_NAME; ?></label><br />
<?php echo zen_draw_input_field('contactname', $name, ' size="20" id="contactname"') . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?>
<br />
<label class="inputLabel" for="email-address"><?php echo ENTRY_EMAIL; ?></label><br />
<?php echo zen_draw_input_field('email', ($error ? $_POST['email'] : $email), ' size="20" id="email-address"') . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?>
<br />
<label for="enquiry"><?php echo ENTRY_ENQUIRY . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?></label><br />
<?php echo zen_draw_textarea_field('enquiry', '20', '5', '', 'id="enquiry"'); ?>

</fieldset>

<div class="buttonRow forward">
<input type="submit" value="<?php echo BUTTON_SEND_ALT ; ?>" />
