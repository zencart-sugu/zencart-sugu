<?php
/**
 * $Id: init_mobile.php,v 1.2 2006/03/25 08:30:23 shida Exp $
 *
 ...
 */
  ...
  require_once(DIR_WS_CLASSES . 'ZenCart/Mobile.php');

  $mobile = new ZenCart_Mobile($_SERVER['HTTP_USER_AGENT'], $db);
  $mobile->init();
